        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                            ...
                            <tbody>
                                @foreach ($orderItems as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{$item->product->brand ? $item->product->brand->name : 'N/A'}}</td>
                ...
                <div class="wg-box mt-5 text-right ">
                    <form action="{{route('user.order.details.cancel')}}" method="POST">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="order_id" value="{{$order->id}}">
                        <button type="submit" class="btn btn-sm btn-danger cancel-order">Cancel Order</button>
                    </form>
                </div>
