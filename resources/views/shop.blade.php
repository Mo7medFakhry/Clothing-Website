            ...
            <div class="accordion" id="price-filters">
                <div class="accordion-item mb-4">
                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                        ...
                        <input class="price-range-slider" type="text" name="price_range" value="{{$min_price}},{{$max_price}}"
                            data-currency="$" />
                    ...
                    <div class="product-card-wrapper">
                        <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                            ...
                            <div class="pc__info position-relative">
                                <p class="pc__category">{{$product->catogery->name}}</p>
                        ...
                        @if(Cart::instance("wishlist")->content()->Where('id', $product->id)->count() > 0)
                                <button type="submit" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 filled-heart"
