                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.catogery.add')}}" class="">
                                                <div class="text">New Category</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.catogeries')}}" class="">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id={{asset('"logo_header_mobile"')}} alt=""
                                            ...
                                            <li>
                                                <ul>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text">Mohamed
                                                                    Fakhry</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2"> Mohamed Fakhry</span>
