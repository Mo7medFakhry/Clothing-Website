                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                @foreach(explode(",", $product->images) as $img)
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{asset('uploads/products')}}/{{$img}}"
                                            width="674" height="674" alt="{{$img}}" />
                                        <a data-fancybox="gallery" href="{{asset('uploads/products')}}/{{$img}}"
                                            data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use href="#icon_zoom" />
                    ...
                    <div class="product-single__thumbnail">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                @foreach(explode(",", $product->images) as $img)
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{asset('uploads/products/thumbnails')}}/{{$img}}" width="104" height="104"
                                            alt="" /> </div>
                                @endforeach
            ...
            <div class="col-lg-5">
                ...
                <div class="product-single__addtolinks">
                    @if(Cart::instance("wishlist")->content()->Where('id', $product->id)->count() > 0)
                        <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart"><svg width="16"
                ...
                <div class="product-single__meta-info">
                    ...
                    <div class="meta-item">
                        ...
                        <span>{{$product->catogery->name}}</span>
                    </div>
                    <div class="meta-item">
                        <label>Tags:</label>
                        <span>N/A</span>
                    ...
                    @foreach ($rproducts as $rproduct)
                        ...
                        <div class="swiper-slide product-card">
                            ...
                            <div class="pc__info position-relative">
                                <p class="pc__category">{{$rproduct->catogery->name}}</p>
